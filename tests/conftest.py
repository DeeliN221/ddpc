...
def data_dir():
    return Path("tests/band_dos_data")
...
def parametrized_data_file_path(data_dir: Path, request) -> Path:
    """
    A single fixture that yields different file paths based on combinations
    of PROJ_TYPES, SPIN_TYPES, FILE_EXTS, and DATA_TYPES.
    """
